...
function lorentz(taille,sexe)
{
    ...
    if(sexe ==="Homme")
    {
        poids =  taille * 100 - 100 - ((taille*100 -150)/4.0);
        console.log("Calcul Poids Lorentz pour " + sexe + " : " + poids + "kg");
    }
    else {
...
function devine(taille,sexe)
{
    ...
    if(sexe ==="Homme")
    {
        ...
        console.log("Calcul Poids Devine pour " + sexe + " : " + poids + "kg");
    }
    else {
...
function lorentzAge(taille,age)
{
    ...
    console.log("Calcul Poids Lorentz Age  : " + poids + "kg");
    return poids;
}
