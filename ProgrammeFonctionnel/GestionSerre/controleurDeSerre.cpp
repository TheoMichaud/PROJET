...
ControleurDeSerre::ControleurDeSerre()
{
  ...
  zones[0]=new Zone(1,GPIO_NUM_4,GPIO_NUM_34);
  zones[1]=new Zone(2,GPIO_NUM_27,GPIO_NUM_34);
  zones[2]=new Zone(3,GPIO_NUM_4,GPIO_NUM_34);
  zones[3]=new Zone(4,GPIO_NUM_4,GPIO_NUM_34);
